...
class Space():
    ...
    def output_image(self, filename):
        ...
        house = Image.open(r"C:\\Users\rifat\Downloads\ai lab\assets\images\House.png").resize(
            (cell_size, cell_size)
        )
        hospital = Image.open(r"C:\\Users\rifat\Downloads\ai lab\assets\images\Hospital.png").resize(
            (cell_size, cell_size)
        )
        font = ImageFont.truetype(r"C:\\Users\rifat\Downloads\ai lab\assets\fonts\OpenSans-Regular.ttf", 30)
